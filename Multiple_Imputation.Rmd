...
impu_data = student_data %>% 
  ...
  select(ageyrs_r, sex, student_r, area, educate_r, currmarr_r, rltnlst1, rltnlst2, rltnlst3, rltnlst4, cndever1, cndever2, cndever3, cndever4, sexp1yr, SEScat)
head(impu_data)
```
...
density(mice_data$imp$student_r)
```
